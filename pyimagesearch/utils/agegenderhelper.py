...
class AgeGenderHelper:
    ...
    def buildAgeBins(self):
        ...
        ageBins = [(0, 2), (4, 6), (8, 13), (15, 20), (25, 32),
            (38, 43), (48, 53), (60, np.inf)] # np.inf: floating point representation of (positive) infinity.
    ...
    def toAgeLabel(self, age):
        ...
        age = age.replace("(", "").replace(")", "").split(", ") # "(4,6)" => ["4","6"]
    ...
    def buildPathsAndLabels(self):
        ...
        foldPaths = os.path.sep.join([self.config.LABELS_PATH,
            "*.txt"])
        foldPaths = glob.glob(foldPaths) # find all the .txt file in the foldPaths
